...
class raw_env(MOAECEnv, EzPickle):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.reward_spaces = dict(
            zip(self.agents, [spaces.Box(low=0, high=100, shape=(self.num_objectives,))] * len(self.possible_agents))
        )
        #print("reward_spaces", self.reward_spaces)

    def reward_space(self, agent: AgentID):
