...
def parse_args():
    ...
    parser.add_argument("--env-id", default="mobeach_v0", help="MOMAland id of the environment to run (check all_modules.py)")
    ...
    """
    parser.add_argument(
        "--ref-point", type=float, nargs="+", default=[0.0,0.0], help="Reference point to use for the hypervolume calculation"
    )
